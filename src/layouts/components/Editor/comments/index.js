...
const EditorComments = ({ handleSetValueComment, valueOfComment = '' }) => {

    return (
        <div className='wrapper-contentComment'>
...
export default memo(EditorComments);
